...
function ArrayFieldTitle(_ref) {
  ...
  return _react2.default.createElement(TitleField, { id: id, title: title, required: required, uiSchema: uiSchema });
}
...
function DefaultArrayItem(props) {
  ...
  var RemoveButton = props.RemoveButtonTemplate || _IconButton2.default;
  var MoveDownButtonTemplate = props.MoveDownButtonTemplate || _IconButton2.default;
  var MoveUpButtonTemplate = props.MoveUpButtonTemplate || _IconButton2.default;

  var classNames = props && props.uiSchema && props.uiSchema && props.uiSchema.classNames || "";
  var columns = "col"; // props.hasToolbar ? "col-9" : "col-12";
  return _react2.default.createElement(
    ...
    props.hasToolbar && _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        (props.hasMoveUp || props.hasMoveDown) && _react2.default.createElement(MoveUpButtonTemplate, {
          type: "outline-dark",
        ...
        (props.hasMoveUp || props.hasMoveDown) && _react2.default.createElement(MoveDownButtonTemplate, {
          type: "outline-dark",
        ...
        props.hasRemove && _react2.default.createElement(RemoveButton, (_React$createElement = {
          type: "danger"
        }, (0, _defineProperty3.default)(_React$createElement, "type", props.type || "danger"), (0, _defineProperty3.default)(_React$createElement, "icon", props.icson || "times"), (0, _defineProperty3.default)(_React$createElement, "className", "array-item-remove"), (0, _defineProperty3.default)(_React$createElement, "tabIndex", "-1"), (0, _defineProperty3.default)(_React$createElement, "style", props.style || btnStyle), (0, _defineProperty3.default)(_React$createElement, "disabled", props.disabled || props.readonly), (0, _defineProperty3.default)(_React$createElement, "onClick", props.onDropIndexClick(props.index)), (0, _defineProperty3.default)(_React$createElement, "uiSchema", props.uiSchema), _React$createElement))
      )
    )
  );
}
...
function DefaultFixedArrayFieldTemplate(props) {
  var AddButtonTemplate = props.AddButtonTemplate;
  // Check if a custom render function was passed in

  var AddButtonComponent = AddButtonTemplate || _AddButton2.default;
  ...
  return _react2.default.createElement(
    ...
    props.canAdd && _react2.default.createElement(AddButtonComponent, {
...
function DefaultNormalArrayFieldTemplate(props) {
  var AddButtonTemplate = props.AddButtonTemplate,
      RemoveButtonTemplate = props.RemoveButtonTemplate,
      MoveUpButtonTemplate = props.MoveUpButtonTemplate,
      MoveDownButtonTemplate = props.MoveDownButtonTemplate;
  // Check if a custom render function was passed in
  ...
  (0, _createClass3.default)(ArrayField, [{
    ...
    value: function renderNormalArray() {
      ...
      var ArrayFieldTemplate = registry.ArrayFieldTemplate,
          ...
          AddButtonTemplate = registry.AddButtonTemplate,
          RemoveButtonTemplate = registry.RemoveButtonTemplate,
          MoveUpButtonTemplate = registry.MoveUpButtonTemplate,
          MoveDownButtonTemplate = registry.MoveDownButtonTemplate;
      ...
      var arrayProps = {
        ...
        formData: formData,
        rawErrors: rawErrors,
        AddButtonTemplate: AddButtonTemplate,
        RemoveButtonTemplate: RemoveButtonTemplate,
        MoveUpButtonTemplate: MoveUpButtonTemplate,
        MoveDownButtonTemplate: MoveDownButtonTemplate
      };
    ...
    value: function renderFixedArray() {
      ...
      var itemsLength = (0, _values2.default)(items).length;
      if (!items || itemsLength < itemSchemas.length) {
        // to make sure at least all fixed items are generated
        items = items || [];
        items = items.concat(
        // spread to fill with undefined
        [].concat((0, _toConsumableArray3.default)(new Array(itemSchemas.length - itemsLength))));
      }
      ...
      var arrayProps = {
        ...
        items: !items.map ? [] : items.map(function (item, index) {
          ...
          var itemSchema = additional && schema.additionalItems ? (0, _utils.retrieveSchema)(schema.additionalItems, definitions, item) : itemSchemas[index];
          if (!itemSchema) {
            return null;
          }
          var itemIdPrefix = idSchema.$id + "_" + index;
