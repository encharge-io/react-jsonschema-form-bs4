...
var Form = function (_Component) {
    ...
    _this.onSubmit = function (event) {
      ...
      if (!_this.props.noValidate) {
        ...
        if ((0, _keys2.default)(errors).length > 0) {
          // backported from v2
          // https://github.com/rjsf-team/react-jsonschema-form/pull/1454
          _this.setState({ errors: errors, errorSchema: errorSchema }, function () {
  ...
  (0, _createClass3.default)(Form, [{
    ...
    value: function validate(formData) {
      ...
      return (0, _validate2.default)(formData, resolvedSchema, validate, transformErrors, additionalMetaSchemas, customFormats);
    }
  }, {
    key: "renderErrors",
...
if (process.env.NODE_ENV !== "production") {
  Form.propTypes = {
    ...
    AddButtonTemplate: _propTypes2.default.func,
    RemoveButtonTemplate: _propTypes2.default.func,
    MoveUpButtonTemplate: _propTypes2.default.func,
    MoveDownButtonTemplate: _propTypes2.default.func,
    ...
    customFormats: _propTypes2.default.object,
